...
class Ed25519 extends EC {
  ...
  def implSign(d: Digest, h: Array[Byte], s: Array[Byte], pk: Array[Byte], pkOff: Int, ctx: Array[Byte], phflag: Byte, m: Array[Byte], mOff: Int, mLen: Int, sig: Array[Byte], sigOff: Int): Unit = {
    dom2(d, phflag, ctx)
  ...
  def signPrehash(sk: Array[Byte], skOff: Int, ctx: Array[Byte], ph: Digest, sig: Array[Byte], sigOff: Int): Unit = {
  ...
  def signPrehash(sk: Array[Byte], skOff: Int, pk: Array[Byte], pkOff: Int, ctx: Array[Byte], ph: Digest, sig: Array[Byte], sigOff: Int): Unit = {
    val m = new Array[Byte](PREHASH_SIZE)
    if (PREHASH_SIZE != ph.doFinal(m, 0)) throw new IllegalArgumentException("ph")
    val phflag = 0x01
  ...
  def verifyPrehash(sig: Array[Byte], sigOff: Int, pk: Array[Byte], pkOff: Int, ctx: Array[Byte], ph: Digest): Boolean = {
    val m = new Array[Byte](PREHASH_SIZE)
    if (PREHASH_SIZE != ph.doFinal(m, 0)) throw new IllegalArgumentException("ph")
    val phflag = 0x01
