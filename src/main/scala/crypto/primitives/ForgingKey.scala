...
class ForgingKey {
  ...
  def update(kes:Kes,t:Long): Unit = {
    val updatedKey = kes.updateKey((L,Si,sig,pki,rp),(t-offset).toInt)
    L = updatedKey._1
    Si = updatedKey._2
    sig = updatedKey._3
    pki = updatedKey._4
  ...
  def update_fast(kes:Kes,t:Long): Unit = {
  ...
  def sign(kes:Kes,m:Array[Byte]): (Array[Byte],Array[Byte],Array[Byte],Long,Array[Byte]) = {
...
object ForgingKey {
  def apply(kes:Kes,seed:Array[Byte],t:Long):ForgingKey = {
