...
object Scalar {
  ...
  @inline def load4(in: Array[Byte], offset: Int): Long = {
    (in(offset).toLong & 0xff) |
      ((in(offset + 1).toLong & 0xff) << 8) |
      ((in(offset + 2).toLong & 0xff) << 16) |
  ...
  def muladd(s: Array[Byte], sOffset: Int, a: Array[Byte], b: Array[Byte], c: Array[Byte]) = {
    ...
    s17 += carry16
    s16 -= carry16 << 21
    val carry18 = (s18 + (1 << 20)) >> 21
    s19 += carry18
    s18 -= carry18 << 21
    val carry20 = (s20 + (1 << 20)) >> 21
    s21 += carry20
    s20 -= carry20 << 21
    val carry22 = (s22 + (1 << 20)) >> 21
    s23 += carry22
    s22 -= carry22 << 21
    ...
    s16 += carry15
    s15 -= carry15 << 21
    val carry17 = (s17 + (1 << 20)) >> 21
    s18 += carry17
    s17 -= carry17 << 21
    val carry19 = (s19 + (1 << 20)) >> 21
    s20 += carry19
    s19 -= carry19 << 21
    val carry21 = (s21 + (1 << 20)) >> 21
    s22 += carry21
    s21 -= carry21 << 21
